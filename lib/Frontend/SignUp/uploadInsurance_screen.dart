...
class UploadInsurance extends StatefulWidget {
  ...
  @override
  State<UploadInsurance> createState() => _UploadInsuranceState();
}

class _UploadInsuranceState extends State<UploadInsurance> {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            Column(
              children: [
                const Text("Upload your insurance information"),
                const SizedBox(
                  height: 40,
                ),
                const Padding(
                  ...
                  child: Text(
                    "Upload photos of insurance documents.",
