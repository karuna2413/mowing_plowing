...
import 'uploadLicense_screen.dart';
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            Column(
              children: [
                const Text("Upload your portfolio"),
                const SizedBox(
                  height: 40,
                ),
                const Padding(
                  ...
                  child: Text(
                    "Upload maximum five photos of your best work and equipment. It will be used in your profile (Optional)",
